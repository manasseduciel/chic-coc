                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="newsletter-wrap">
                                ...
                                <img src="img/images/newsletter_shape01.png" alt="" class="newsletter-shape top-shape wow fadeInDownBig" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInDownBig;">
                                <img src="img/images/newsletter_shape02.png" alt="" class="newsletter-shape bottom-shape wow fadeInUpBig" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUpBig;">
                            </div>
                        </div>
                    </div>
                </div>
