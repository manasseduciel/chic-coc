        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Modifier l'article</h4>
                        ...
                        <form action="{{route('blog.update', $edit->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="mb-3">
                                            <label for="cleave-ccard" class="form-label">Titre de l'annonce  @error('name')
                                ...
                                <br>
                                <div class="col-sm-12">
                                    <button class="btn btn-dark">Ajouter l'article</button>
