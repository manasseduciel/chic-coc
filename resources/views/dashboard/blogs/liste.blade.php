        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">NOMBRE Articles  </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                ...
                                <div class="col-sm-auto">
                                    <div>
                                        <button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal">
                                            <i class="ri-add-line align-bottom me-1"></i> Nouveau article</button>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="email">
                                                    <img src="{{asset('articles/images/'.$ressource->image)}}" alt="" style="height: 60px; width:60px;">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <div class="edit">
                                                            <a href="{{route('blog.edit', $ressource->id)}}" class="btn btn-sm btn-primary edit-item-btn"> Editer</a>
                                                        </div>
                                                        <div class="remove">
                                                            <a href="{{route('blog.destroy', $ressource->id)}}" class="btn btn-sm btn-danger remove-item-btn" onclick="return confirm('Voulez-vous vraiment accomplir cette action ?')">  Suppression</a>
            ...
            <form  method="POST" action="{{route('blog.store')}}" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <div class="hstack gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-success" id="add-btn">Enregistrer l'article</button>
